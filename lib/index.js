	...
	*/
	...
	ctx.inject(["settings"], (settingsCtx) => {
		...
		const merged = () => ({
			...
			...sources.cn().disabledModelsCN === void 0 ? {} : { disabledModelsCN: sources.cn().disabledModelsCN },
			...sources.ai().useMaximumContextWindow === void 0 ? {} : { useMaximumContextWindow: sources.ai().useMaximumContextWindow },
			...sources.ai().disabledModelsAI === void 0 ? {} : { disabledModelsAI: sources.ai().disabledModelsAI },
