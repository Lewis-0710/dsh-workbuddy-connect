...
const WORKBUDDY_PROVIDER = "codebuddy";
...
function createWorkBuddyAdapter(options) {
	...
	const providerId = options.providerId ?? "codebuddy";
...
*/
const WORKBUDDY_SETTINGS_NS = "codebuddy";
/**
