import { $ as readBundleVersion, A as workbuddyOwnAuthPath, B as PROBE_EFFORT_CANDIDATES, C as resolveLoginRegion, D as WORKBUDDY_DATA_DIR_NAME, E as WORKBUDDY_DATA_DIR_ENV, F as normalizeCredits, G as chatUserAgent, H as randomSentinel, I as parseModelCatalog, J as resolveChatIdentity, K as fallbackChatIdentity, L as prepareChatBody, M as WorkBuddyUpstreamClient, N as classifyUpstreamError, O as WorkBuddyCredentialStore, P as modelWithCurrentPromotion, Q as installedAppVersion, R as prepareInternationalChatBody, S as normalizeLoginRegion, T as WORKBUDDY_CREDENTIAL_SOURCE, U as CN_APP_VERSION_FILENAME, V as probeModel, W as FALLBACK_CN_APP_VERSION, X as WORKBUDDY_APP_VERSION_FILENAME, Y as validCliVersion, Z as appUserAgent, _ as WORKBUDDY_LOGIN_PATH, a as WORKBUDDY_HOST_HEARTBEAT_FILENAME, b as LOGIN_PENDING_CODE, c as processStartTimeMs, d as writeHostHeartbeat, et as resolveAppVersion, f as WORKBUDDY_CONNECT_VERSION, g as WORKBUDDY_AI_LOGIN_PATH, h as WorkBuddyCatalog, i as variantFor, j as workbuddyPluginDataDir, k as parseWorkBuddyAuth, l as readHostHeartbeat, m as FALLBACK_WORKBUDDY_MODELS, n as CN_VARIANT, o as clearHostHeartbeat, p as FALLBACK_WORKBUDDY_AI_MODELS, q as readCliVersion, r as WORKBUDDY_VARIANTS, s as isHeartbeatProcessAlive, t as AI_VARIANT, tt as validAppVersion, u as workbuddyHostHeartbeatPath, w as WORKBUDDY_AUTH_FILENAME, x as WorkBuddyLoginClient, z as regionOf } from "./variants-CfRZAubs.js";
