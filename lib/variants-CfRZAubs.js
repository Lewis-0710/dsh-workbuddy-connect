...
//#endregion
export { readBundleVersion as $, workbuddyOwnAuthPath as A, PROBE_EFFORT_CANDIDATES as B, resolveLoginRegion as C, WORKBUDDY_DATA_DIR_NAME as D, WORKBUDDY_DATA_DIR_ENV as E, normalizeCredits as F, chatUserAgent as G, randomSentinel as H, parseModelCatalog as I, resolveChatIdentity as J, fallbackChatIdentity as K, prepareChatBody as L, WorkBuddyUpstreamClient as M, classifyUpstreamError as N, WorkBuddyCredentialStore as O, modelWithCurrentPromotion as P, installedAppVersion as Q, prepareInternationalChatBody as R, normalizeLoginRegion as S, WORKBUDDY_CREDENTIAL_SOURCE as T, CN_APP_VERSION_FILENAME as U, probeModel as V, FALLBACK_CN_APP_VERSION as W, WORKBUDDY_APP_VERSION_FILENAME as X, validCliVersion as Y, appUserAgent as Z, WORKBUDDY_LOGIN_PATH as _, WORKBUDDY_HOST_HEARTBEAT_FILENAME as a, LOGIN_PENDING_CODE as b, processStartTimeMs as c, writeHostHeartbeat as d, resolveAppVersion as et, WORKBUDDY_CONNECT_VERSION as f, WORKBUDDY_AI_LOGIN_PATH as g, WorkBuddyCatalog as h, variantFor as i, workbuddyPluginDataDir as j, parseWorkBuddyAuth as k, readHostHeartbeat as l, FALLBACK_WORKBUDDY_MODELS as m, CN_VARIANT as n, clearHostHeartbeat as o, FALLBACK_WORKBUDDY_AI_MODELS as p, readCliVersion as q, WORKBUDDY_VARIANTS as r, isHeartbeatProcessAlive as s, AI_VARIANT as t, validAppVersion as tt, workbuddyHostHeartbeatPath as u, WORKBUDDY_PROBE_PATH as v, WORKBUDDY_AUTH_FILENAME as w, WorkBuddyLoginClient as x, WORKBUDDY_STATUS_PATH as y, regionOf as z };
